...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Employeees</h2>
        </template>
        ...
        <div class="py-12">
            ...
            <div class="bg-white grid v-screen place-items-center">
                <table class="table-auto border corder-gray-400">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <td class="border border-gray-400 px-2 py-2">
                            <WarningButton
                            @click="$event => openModal(2, emp.name, emp.email, emp.phone, emp.department_id, emp)">
        ...
        <Modal :show="modal" @close="closeModal">
            ...
            <div class="p-3 mt-3">
                ...
                v-model="form.name" type="text" class="mt-1 block w3/4"
            ...
            <div class="p-3 mt-3">
                ...
                <TextInput id="email"
                v-model="form.email" type="text" class="mt-1 block w3/4"
            ...
            <div class="p-3 mt-3">
                ...
                <TextInput id="phone"
                v-model="form.phone" type="text" class="mt-1 block w3/4"
                placeholder="Phone"></TextInput>
                <InputError :message="form.errors.phone" class="mt-2"></InputError>
            </div>
            <div class="p-3 mt-3">
                <InputLabel for="department.id" value="Department:"></InputLabel>
                <SelectInput id="department.id" :options="departments"
                v-model="form.department_id" type="text" class="mt-1 block w3/4"
                ></SelectInput>
