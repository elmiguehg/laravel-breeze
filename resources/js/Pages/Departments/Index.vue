...
<template>
    <Head title="Departmets" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Departmets</h2>
        </template>
                ...
                <table class="table-auto border corder-gray-400">
                    <thead>
                        <tr class="bg-gray-100">
                            ...
                            <th class="px-4 py-4">Departmets</th>
                            <th class="px-4 py-4"></th>
                            <th class="px-4 py-4"></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <td class="border border-gray-400 px-4 py-4">
                                ...
                                :class="'px-4 py-2 bg-yellow-400 test-white border rounded-md font-semibold text-xs'">
